 ...
 **/
 ...
 int setup_sensor() {
   ...
   if (!mlx.begin(MLX90640_I2CADDR_DEFAULT, &Wire)) {
     Serial.println("[MLX] ERRO: MLX90640 não encontrado!");
     return 0;
   }
   
   // Configurações para 2Hz para economizar recursos
   Serial.println("[MLX] Configurando MLX90640 para 2Hz...");
   mlx.setMode(MLX90640_CHESS);
   mlx.setResolution(MLX90640_ADC_18BIT);
   mlx.setRefreshRate(MLX90640_2_HZ);
   
   Serial.println("[MLX] Sensor MLX90640 inicializado com sucesso");
   return 1;
 }
 ...
 int get_sensor_data() {
   ...
   // Log simplificado para economizar recursos
   Serial.printf("[MLX] Temp média/mín/máx: %.2f/%.2f/%.2f°C\n", avgTemp, minTemp, maxTemp);
   return 1;
 }
 ...
 void setup() {
   ...
   Serial.begin(115200);
   delay(100);
   Serial.println("[INIT] Iniciando ESP32-CAM Térmico");

   Wire.begin(I2C_DATA_PIN, I2C_CLOCK_PIN);
   Serial.printf("[I2C] Wire iniciado em SDA=%d, SCL=%d\n", I2C_DATA_PIN, I2C_CLOCK_PIN);
